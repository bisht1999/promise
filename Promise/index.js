...
function updateLastUserActivityTimes(post) {
    return new Promise((resolve, reject)=>{
        setTimeout(() => {
...
function userupdatespost(){
    Promise.all([createPost, updateLastUserActivityTimes])
    .then(([createPost, updateLastUserActivityTimes])=>{
        console.log(updateLastUserActivityTimes)
    })
